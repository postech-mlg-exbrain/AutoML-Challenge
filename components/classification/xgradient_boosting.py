...
from components.base import AutoSklearnClassificationAlgorithm
...
class XGradientBoostingClassifier(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        n_estimators = cs.add_hyperparameter(UniformIntegerHyperparameter(
            name="n_estimators", lower=50, upper=500, default=100, log=True))
        ...
        min_child_weight = cs.add_hyperparameter(UniformIntegerHyperparameter(
            ...
            log=False))
        colsample_bytree = cs.add_hyperparameter(UniformFloatHyperparameter(
            name="colsample_bytree", lower=0.5, upper=1.0, default=1.0))
        scale_pos_weight = cs.add_hyperparameter(UniformFloatHyperparameter(
            name="scale_pos_weight", lower=0.5, upper=2.0, default=1.0))
